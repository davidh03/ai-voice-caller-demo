...
const Homepage = ({
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      {/* Top Nav */}
      <header className="bg-[#060A39] px-6 py-4 flex items-center justify-between shadow-md">
        <div className="flex items-center gap-3">
          <img src="/assets/logo-cadre-crew.svg" alt="Cadre Crew" className="h-7" />
          <span className="text-white/60 text-sm font-medium border-l border-white/20 pl-3">
            AI Voice Caller
          </span>
        </div>
